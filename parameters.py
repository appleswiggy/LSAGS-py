...
class GroupParameters:
    def __init__(self, prime, generator, subgroupSize) -> None:
        self.prime = prime
...
class KnownParameters:
    RFC5114_2_3_256 = GroupParameters(
        useful_methods.HexToInt(
            """
    ...
    RFC5114_2_2_224 = GroupParameters(
        useful_methods.HexToInt(
            """
    ...
    RFC5114_2_1_160 = GroupParameters(
        useful_methods.HexToInt(
            """
    ...
    ExampleDsa_160 = GroupParameters(
        useful_methods.HexToInt(
            """
